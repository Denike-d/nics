      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-6">
          <div className="flex items-center gap-2">
            <span className="text-green-700 font-semibold">Apply for clearance</span>
          </div>
          <div className="h-px flex-1 bg-gray-300"></div>
          <div className="flex items-center gap-2">
            <span className="text-gray-600 font-medium">Import/export items</span>
          </div>
        </div>

        {/* Form */}
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          <h1 className="text-xl font-bold text-gray-900 mb-6">Add Import Item</h1>
