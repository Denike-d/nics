      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex border-b border-dotted border-blue-300 pb-2">
              <span className="text-gray-600 font-medium w-40">
                Client Name
              </span>
              <span className="text-gray-800">IG Global Services</span>
            </div>
            <div className="flex border-b border-dotted border-blue-300 pb-2">
              <span className="text-gray-600 font-medium w-40">
                Client Email
              ...
              <tbody>
                {importItems.map((item) => (
                  ...
                  >
                    ...
                    <td className="p-3 text-sm text-gray-800">{item.hsCode}</td>
